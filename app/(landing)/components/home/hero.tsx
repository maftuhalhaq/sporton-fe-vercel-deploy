    ...
    <section id="hero-section" className="container mx-auto h-screen flex">
      <div className="relative self-center ">
        ...
        <div className="relative ml-40 w-full">
          <div className="text-primary italic">Fiday Sale. 50%</div>
          <h1 className="font-extrabold  text-[95px] italic bg-gradient-to-b leading-tight from-black to-[#9797979] bg-clip-text text-transparent ">
